...
import megaplayServersController from '../controllers/megaplayServers.controller';
import megaplaySourcesController from '../controllers/megaplaySources.controller';
...
// MegaPlay — DIRECT (m3u8) source, keyed by AniList id.
router.get('/megaplay/servers/:anilistId', handler(megaplayServersController));
router.get('/megaplay/sources/:anilistId', handler(megaplaySourcesController));
